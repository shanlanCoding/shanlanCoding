...
### 本博客使用的[Pure](https://github.com/cofess/hexo-theme-pure)主题，目前已经通过Git备份至[GitHub](https://github.com/shanlanCoding/myPure)和[Coding](https://dev.tencent.com/u/shanl/p/myPure/git)（私有访问），推荐你也可以这样做。具体的方法是：
